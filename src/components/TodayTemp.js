        ...
        <Box sx={{ display: "flex", flexDirection: "row" }}>
          ...
          >
            <Box display="flex" flexDirection="row">
              <Typography width="300px" variant="h5" mr="50px" fontWeight={800}>
                {" "}
          ...
          <Box position="absolute">
            ...
            <Box
              display="flex"
              flexDirection="row"
              sx={{ mt: "33px", ml: "25px", gap: "62px" }}
            >
              <Typography fontWeight={600} variant="h6">
                {Math.round(result2[0].main.temp_max - 273.15 - 5)}
                <span>&deg;C </span>
              </Typography>
              <Typography fontWeight={600} variant="h6">
                {Math.round(result2[0].main.temp_max - 273.15 + 6)}
                <span>&deg;C </span>
              </Typography>
              <Typography fontWeight={600} variant="h6">
                {Math.round(result2[0].main.temp_max - 273.15 + 3)}
                <span>&deg;C </span>
              </Typography>
              <Typography fontWeight={600} variant="h6">
                {Math.round(result2[0].main.temp_max - 273.15 - 7)}
                <span>&deg;C </span>
              </Typography>
            </Box>
          </Box>
          ...
          <Box position="absolute" sx={{ m: "20px 0 0 550px" }}>
            ...
            <Typography variant="h6" sx={{ mt: "20px", fontWeight: "800" }}>
              {result.name}
            </Typography>
            <Typography
              variant="h4"
              sx={{ m: "70px 0 0 10px", fontWeight: "600" }}
            >
              {Math.round(result2[0].main.temp_max - 273.15)}
              <span>&deg;C </span>
            </Typography>
