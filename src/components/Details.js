...
const Details = ({ result, result2, airPollution }) => {
  ...
  return result &&
    ...
    <Box
      sx={{ mt: "20px", ml: "20px", display: "flex", flexDirection: "column" }}
    >
      <Stack direction="row" gap={4}>
        ...
        <Box sx={{ position: "absolute", ml: "20px", mt: "20px" }}>
          ...
          <Typography m="8px 0 0 8px">{result.weather[0].main}</Typography>
        </Box>
        <Box
          sx={{
            position: "absolute",
        ...
        <Box sx={{ position: "absolute", ml: "460px", mt: "20px" }}>
          <Box sx={{ display: "flex", flexDirection: "row", gap: "15px" }}>
            ...
            <Box color={"white"}>
              ...
              <Typography fontWeight={400}>
                PM10 : {airPollution.PM10.concentration}
              </Typography>
              <Typography fontWeight={400}>
                CO : {airPollution.CO.concentration}
              </Typography>
              <Typography fontWeight={400}>
                NO2 : {airPollution.NO2.concentration}
              </Typography>
              <Typography fontWeight={400}>
                O3 : {airPollution.O3.concentration}
              </Typography>
              <Typography fontWeight={400}>
                SO2 : {airPollution.SO2.concentration}
              </Typography>
            </Box>
          </Box>
          <Box
          ...
          <Typography m="8px 0 0 8px" color={"white"}>
            West Wind
          </Typography>
        </Box>
      </Stack>
